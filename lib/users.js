...
export const isAdmin = (user) => user && user['https://emergingcurators.org/roles'].includes('apply_admin');
export const isJuror = (user) => user && user['https://emergingcurators.org/roles'].includes('apply_juror');
