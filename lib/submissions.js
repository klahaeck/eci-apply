...
export const getSubmissions = async ({ programId, _id, userId, role, searchQuery, sortBy, sortOrder, perPage, pageNumber, isPanel, filterFinalists }) => {
  ...
  if (isPanel || filterFinalists) query.finalist = true;
  ...
  aggregate = [...aggregate, { '$sort': { ...sort, submittedAt: -1, createdAt: -1 } }];
