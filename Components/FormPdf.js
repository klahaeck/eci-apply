...
const FormPdf = ({ submission, assetData, onSubmit, hideModal }) => {
  ...
  return (
    <Form onSubmit={handleSubmit(thisOnSubmit)} className="mt-3">
      ...
      {!assetData && !loading && <div>
        ...
        {errors.file && <><br /><Form.Text className="text-danger">A PDF file is required</Form.Text></>}
        {filesContent.length === 0 && <><br /><Form.Text className="mb-2">Please choose a PDF</Form.Text></>}
